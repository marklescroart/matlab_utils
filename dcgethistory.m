...
if(sizeMe==3)
  ...
  for n = 3:numtrials 
	  hist(theorder(n), theorder(n-1),theorder(n-2)) = hist(theorder(n), theorder(n-1),theorder(n-2))+1;
  end
end
...
if(sizeMe==4)
  ...
  for n = 4:numtrials
	hist(theorder(n), theorder(n-1),theorder(n-2),theorder(n-3))=hist(theorder(n), theorder(n-1),theorder(n-2),theorder(n-3))+1;
  end
end
