...
% Usage: design2bvprt(design_in, prt_out)
% 
% makes protocol file (BV '.prt' file) from a 'design' file

% parameters for this experiments:
event = {'A1_A1', 'A1_A2', 'A1_B1', 'A1_B2','Blank'}; % for event labels 1, 2, 3, 4, 5...
color = {[255 0 0], [0 255 0], [0 0 255], [255 255 0], [128 128 128]};
TRperTrial = 2;
