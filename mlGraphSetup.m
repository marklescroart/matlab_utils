function mlGraphSetup(Title,Xlabel,Ylabel,xlim,ylim,xtick,xticklabel,ytick,yticklabel)
...
title(Title,'fontname','Arial','fontsize',20,'fontweight','Bold');
xlabel(Xlabel,'fontname','Arial','fontsize',18);
