function mlGraphSetup_sm(Title,Xlabel,Ylabel,xlim,ylim,xtick,xticklabel,ytick,yticklabel)

% Usage: mlGraphSetup_sm(Title,Xlabel,Ylabel [,xlim,ylim,xtick,xticklabel,ytick,yticklabel])
% 
% Setting all graph properties at one go !!! With smaller fonts for smaller
% plots !!!
% 
% All inputs past Ylabel are optional; put in empty fields ("[]") if you do
% not wish to specify an input, and keep to the variable order.
% 
...
title(Title,'fontname','Arial','fontsize',14,'fontweight','Bold');
xlabel(Xlabel,'fontname','Arial','fontsize',12);
ylabel(Ylabel,'fontname','Arial','fontsize',12);
