...
%
% Clear Color [0 0 0 0] (Black, Alpha = 0)
% 
% Light0:
...
% Drawing (material) color of Gray * Temporarily Red *      (Specified by GLst.WhichStartColor)
% Clipping Planes at z =.1 and 200      (Specified by GLst.zNear and GLst.zFar)
% Fov in Y direction of 32 degrees      (Specified by GLst.fovY)
% 
...
%%% Perspective:
GLst.fovY = 32;  % Field of view is +/- 32 degrees from line of sight.
GLst.zNear = .1; % Clipping Planes
GLst.zFar = 200;

%%% Materials (for front only):
GLst.WhichStartColor = GLCol.Red; %Gray200;
