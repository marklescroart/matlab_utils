...
for iTrial = 1:nTrials;
    ...
    start1  = (iTrial-1)*nSecPerCond*sf+1;
    finish1 = (iTrial-1)*nSecPerCond*sf+ImTime*sf;
    start2  = (iTrial-1)*nSecPerCond*sf+ImTime*sf+ISI*sf+1;
    finish2 = (iTrial-1)*nSecPerCond*sf+ImTime*sf+ISI*sf+ImTime*sf;
