function [varargout] = mlSetResponseKeysImg(win, ImTex,varargin)


% Usage: [KeyVarName1, [KeyVarName2,] ...] = mlSetResponseKeysImg(Window, ImageTextureArray,KeyTitle1, [KeyTitle2,] ... )
%
...
ImRect = CenterRectOnPoint([0 0 256 256],ScrX,ScrY-172);
...
if OnPTBScreen
    ...
    Screen('DrawTexture',win,ImTex(1),[],ImRect);
...
for iKey = 1:nargin-2
    ...
    if iKey < nargin-2
        if OnPTBScreen
            ...
            Screen('DrawTexture',win,ImTex(iKey+1),[],ImRect);
