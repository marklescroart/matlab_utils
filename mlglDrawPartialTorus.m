function PartialTorusDL = mlglDrawPartialTorus(TorusFract, TubeRadius, Radius, Slices, Stacks)

% usage: PartialTorusDL = mlglDrawPartialTorus([TorusFract,] [TubeRadius,] [Radius,] [Slices,] [Stacks])
% 
